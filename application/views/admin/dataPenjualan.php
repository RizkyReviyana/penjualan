            ...
            <div id="table-datatables">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m8 l11">
                        <!-- Export Buttons -->
                        <a href="<?php echo base_url(); ?>penjualan/export" class="btn cyan waves-effect waves-light">
                            Excel <i class="mdi-action-print right"></i>
                        </a>
                        <a href="<?= base_url(); ?>penjualan/exportPDF" class="btn waves-effect waves-light indigo">
                            PDF <i class="mdi-action-print right"></i>
                        </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>penjualan/hapus/<?= $penjualan->idPenjualan ?>" 
                                               data-target="modal1" class="modal-trigger" style="color:red"
