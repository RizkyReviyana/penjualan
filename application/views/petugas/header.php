        ...
        <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a class="dropdown-button" href="#!" data-activates="dropdown1">
                    <i class="mdi-editor-format-list-bulleted" style="font-size: 40px"></i>
                </a></li>
            ...
            <ul class="side-nav" id="mobile-demo">
                ...
                <li class="divider"></li>
                <li><a href="<?php echo base_url(); ?>barang/barang">
                    <i class="mdi-editor-format-list-bulleted" style="font-size: 30px">Barang</i></a>
                </li>
                <li><a href="<?php echo base_url(); ?>penjualan/penjualan">
                    <i class="mdi-editor-format-list-bulleted" style="font-size: 30px">Penjualan</i></a>
                </li>
                <li class="divider"></li>
                <li><a href="<?php echo base_url(); ?>petugas/profil">
                    <i class="mdi-action-face-unlock" style="font-size: 30px">Profil</i></a>
                </li>
                <li><a href="<?php echo base_url(); ?>login/logout">
                    <i class="mdi-hardware-keyboard-tab" style="font-size: 30px">Logout</i></a>
                </li>
            </ul>
        </div>
    </nav>
